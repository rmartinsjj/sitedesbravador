...
function App() {
  ...
  function getPartnerImage(partnerName: string): string | undefined {
    const imageMap: { [key: string]: string } = {
      'MIDHU Cosméticos': encodeURI('/520281855_17846432826526076_2978160867539881913_n. copy.jpg'),
      ...
      'Anfora': encodeURI('/anfora/489744502_1699564817612603_6487046323882617235_n. copy.jpg'),
      'Studio Marlon Castro': '/studio-marlon/2.jpg',
      'Amanda Hastenreiter': '/amanda-hastenreiter/3.jpg',
      'Sallen Almeida': encodeURI('/sallen-almeida/Move on !!!!! .Vestindo serie ouro da @squadra_oficial . Descrevo esse material em uma palavra-  copy.jpg'),
      'Essenza Squadra': encodeURI('/essenza-squadra/475756504_668226198872119_5342152064430325660_n. copy.jpg'),
      'Carol Toledo': '/carol-toledo/474641049_18482749879048892_1106793479925009027_n..jpg',
      'Rafael Martins': '/rafael-martins/4.jpg',
      'HomeTech': encodeURI('/home-tech/534303763_17910260268192549_4749112964959181747_n. copy copy.jpg'),
      ...
      'Loop Kids': encodeURI('/loop-kids/424926422_3728554757433634_5123167556507636003_n. copy.jpg'),
      'Portal Madeiras': '/portal-madeira/5re.png',
      'Nadyne Passos': encodeURI('/nadyne-passos/489608387_475746338865716_5661852849399704938_n. copy.jpg'),
      'Play School': '/home-play-school/9re.png',
      'Auto Fera Shopcar': '/auto-fera-shopcar/117176420_114022000249893_2885753175732531306_n.jpg',
      'MD Refrigeração': '/md-refrigeracao/11.jpg',
      'Vanessa Regly': '/vanessa-regly/535341484_18535831426057241_3867467237104827410_n..jpg',
      'Renan Brindes Personalizados': '/renan-brindes-personalizados/558688327_18058308911544250_2997466184651862813_n.-removebg-preview.png',
      ...
      'Chess Lab': encodeURI('/chess-lab/WhatsApp Image 2025-10-09 at 23.02.51.jpeg'),
      'Juliana Otone': '/renan-juliana-otone/94834216_1152469451768950_3492402787877126144_n..jpg',
      ...
      'WorkFlow': encodeURI('/renan-workflow/Com o Workflow.jpg'),
    ...
    <div className="min-h-screen bg-white">
      ...
      {activeSection === 'inicio' && (
        ...
        <div
          ...
          style={{ backgroundImage: "url('/momentos-especiais/20set2025-batismo-desbravadores-275 (1).jpg')" }}
        ></div>
...
{/* Seu apoio faz a diferença */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-base sm:text-lg text-gray-600 max-w-3xl mx-auto px-4">
              Escolha o plano que melhor se adequa às suas possibilidades e comece a apoiar o desenvolvimento de adolescentes desbravadores
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto mb-8 sm:mb-12">
            ...
            <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-2xl hover:shadow-3xl transition-shadow relative border-4 border-yellow-400 transform md:-translate-y-4 flex flex-col">
              ...
              <button className="w-full bg-yellow-400 text-gray-900 py-3 rounded-full font-semibold hover:bg-yellow-500 transition-colors mt-auto">
            ...
            <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-lg hover:shadow-xl transition-shadow relative flex flex-col">
              ...
              <button className="w-full bg-purple-600 text-white py-3 rounded-full font-semibold hover:bg-purple-700 transition-colors mt-auto">
      ...
      <footer className="bg-gray-900 text-white py-6 sm:py-9">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
