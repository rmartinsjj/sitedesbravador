  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {activeSection === 'inicio' && (
        <>
          {/* Hero Section */}
          <section className="relative min-h-[80vh] sm:min-h-screen overflow-hidden bg-black flex items-center justify-center">
        ...
        <div className="relative text-center px-4 py-12 sm:py-20 max-w-4xl z-10">
